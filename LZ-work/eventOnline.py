...
sr_field_dt ={
    ...
    'borrow':'中文123','checkResult':'风控审核结果 ', 'tokenId':'设备指纹（网页版） ', 'blackBox':'设备指纹（移动端原生SDK接入） ', 'cardNo':'银行卡号 ', 'devType':'设备类型 ', 'ipAddress':'IP地址 ', 'flowChannel':'流量渠道（my钱包用） ', 'appName':'同盾应用名称 ', 'checkTime':'风控审核时间 ',
...
#强风控
sr_need_lst = ['checkResult', 'tokenId', 'blackBox', 'cardNo', 'devType', 'ipAddress', 'flowChannel', 'appName', 'checkTime',
...
#弱风控
wr_need_lst = ['checkTime', 'checkResult', 'time', 'poundage', 'realAmount', 'orderAmount', 'nper', 'orderNo','inLoanOverdueDay','isCycleBorrow'
    ,'phone', 'ipAddr', 'coordinateX', 'coordinateY', 'devType', 'devOs', 'devOsVersion', 'appVersion', 'devId', 'serialNum', 'wifiName', 'bssid'
    , 'electricity', 'storage', 'storageUsed', 'isCharging', 'gyroscopeX', 'gyroscopeY', 'gyroscopeZ', 'isRoot']
#实名
...
def get_mysql(oid):
    host = 'rm-bp1c469j3h7ao1z07rw.mysql.rds.aliyuncs.com'
    engine = create_engine('mysql+pymysql://app_readonly:Linzi@9527@{}:3306/risk_biz'.format(host))
...
def get_mongo(oid):
    client = MongoClient(host='dds-bp1f73a9a0d880741.mongodb.rds.aliyuncs.com',port=3717)
